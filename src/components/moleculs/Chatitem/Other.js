...
import { DummyPegawai9 } from '../../../assets'
...
const styles = StyleSheet.create({
    ...
    chatComponent: {maxWidth: '80%', padding: 12, paddingRight: 18, backgroundColor: colors.primary, borderRadius: 10, borderBottomLeftRadius: 0,},
